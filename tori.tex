...
generates $\Gamma / I$.  When we eventually construct a torus $\bT$ from the fixed choices
...
$\cE_\Gamma$ will be empty for large enough residue characteristic.  From the point of view
of motivic integration, this case is indistinguishable from the empty set.
\end{rem}
%\begin{rem}
...
In fact, our construction of algebraic tori above in \S \ref{sub:def_tori} is a special case of this construction. \todo{Tameness?} 
