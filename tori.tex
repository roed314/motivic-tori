...
Moreover, as in \cite{gordon-hales:15a}*{\S 2.2}, we have a parameter space $Z$ encoding field extensions and Galois cocycles.
...
that parameterizes the \emph{quasi-split} groups with a given absolute root datum (cf. \cite{gordon-hales:15a}*{\S 2.2.2}).  
